...
**Request ID:** EMAIL_ai-employee_2_20260220_161430
**Type:** Email Send
...
3. Create file: `vault/Approved/APPROVAL_REQUEST_EMAIL_ai-employee_2_20260220_161430_APPROVED.md`
4. Content can be:
   ```
   # Approval Granted
...
1. Review the details above
2. If issues found, create file: `vault/Rejected/APPROVAL_REQUEST_EMAIL_ai-employee_2_20260220_161430_REJECTED.md`
3. Content should include rejection reason
4. Item will be marked as rejected and logged

### Timeline:
- Requests created: 2026-02-20 16:14:30
...
Approval request file: APPROVAL_REQUEST_EMAIL_ai-employee_2_20260220_161430.md
Location: vault/Pending_Approval/APPROVAL_REQUEST_EMAIL_ai-employee_2_20260220_161430.md
